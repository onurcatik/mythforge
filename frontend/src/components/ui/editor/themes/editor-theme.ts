...
export const editorTheme: EditorThemeClasses = {
  ...
  rtl: "text-right",
  heading: {
    h1: "scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl mt-6 first:mt-0",
    h2: "scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight mt-6 first:mt-0",
    h3: "scroll-m-20 text-2xl font-semibold tracking-tight mt-6 first:mt-0",
    h4: "scroll-m-20 text-xl font-semibold tracking-tight mt-6 first:mt-0",
    h5: "scroll-m-20 text-lg font-semibold tracking-tight mt-6 first:mt-0",
    h6: "scroll-m-20 text-base font-semibold tracking-tight mt-6 first:mt-0",
  },
  ...
  text: {
    bold: "font-bold",
    code: "bg-secondary p-1 rounded-md",
    italic: "italic",
  ...
  table: "EditorTheme__table w-full overflow-scroll border-collapse",
  tableCell:
    'EditorTheme__tableCell min-w-24 relative border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right"',
  ...
  hr: 'p-0.5 border-none my-3 mx-0 cursor-pointer after:content-[""] after:block after:h-0.5 after:bg-muted selected:ring-2 selected:ring-primary selected:ring-offset-2 selected:user-select-none',
